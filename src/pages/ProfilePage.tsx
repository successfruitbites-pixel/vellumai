        ...
        <GlassCard className="p-8 text-center flex flex-col items-center">
          ...
          <div>
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-slate-800 border border-slate-200 hover:bg-slate-50 font-bold py-3 px-4 rounded-xl transition-colors shadow-sm"
            >
            ...
            <div className="text-xs text-slate-400 mt-2 mb-8">⚙️ Real Google Sign-In requires Supabase Auth setup</div>
          </div>
      ...
      <GlassCard className="p-8 flex items-center gap-4 sm:gap-6 overflow-hidden">
        ...
        <div className="min-w-0 flex-1">
          ...
          {user?.email ? (
            ...
            <p className="text-sm sm:text-base text-amber-500 dark:text-amber-400 mt-1 truncate">
              No email connected — sign in with Google to sync
            </p>
          )}
        </div>
